...
namespace EventManagerAPI.Migrations
{
    ...
    [Migration("20211009114852_initial6")]
            ...
            modelBuilder.Entity("EventManager.Domain.POCO.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            StartDate = new DateTime(2021, 10, 9, 15, 48, 52, 332, DateTimeKind.Local).AddTicks(7572),
                            Title = "titletest",
                            UserId = 1,
                            isPublished = false
                        },
                        new
                        {
                            ...
                            Description = "descr",
                            ModifiedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            StartDate = new DateTime(2021, 10, 9, 15, 48, 52, 334, DateTimeKind.Local).AddTicks(657),
                            Title = "EventTitle",
                            UserId = 2,
                            isPublished = false
                        },
                        new
                        {
                            ...
                            ModifiedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            StartDate = new DateTime(2021, 10, 9, 15, 48, 52, 334, DateTimeKind.Local).AddTicks(729),
                            Title = "FootballMatch",
                            UserId = 3,
                            isPublished = false
                        });
